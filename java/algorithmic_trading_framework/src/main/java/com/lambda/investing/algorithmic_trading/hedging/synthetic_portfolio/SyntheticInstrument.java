...
public class SyntheticInstrument extends Instrument {
    ...
    public Set<String> getInstrumentPks() {
        //
        Set<String> instrumentPkss = new HashSet<>();
        for (Instrument instrument : instrumentToBeta.keySet()) {
            instrumentPkss.add(instrument.getPrimaryKey());
        }
        return instrumentPkss;
    }
